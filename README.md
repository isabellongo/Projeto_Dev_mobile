...
A parte feita pela aluna Isabel foi: Design geral, página da câmera, confirmação para apagar uma nota e bugfixes no banco de dados.\
A parte feita pelo aluno Danilo foi: Página de login, Router, Controller, autenticação via Firebase. \
E, por fim, a parte feita pelo aluno Paulo foi: edição e organização das notas, alterações no controlador, banco de dados via firebase.
## Instalação
